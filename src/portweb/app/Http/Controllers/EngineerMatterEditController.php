...
use BusinessLogic\EngineerMatterEditBusinessLogic;
use Constants\ApiConstants as AC;

final class EngineerMatterEditController extends BaseApiController
{
    //API呼び出し
    ...
    {
        return  new EngineerMatterEditBusinessLogic($initdata);
    }
