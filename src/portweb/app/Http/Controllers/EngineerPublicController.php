...
use BusinessLogic\EngineerPublicBusinessLogic;
use Constants\ApiConstants as AC;

final class EngineerPublicController extends BaseApiController
{
    //API呼び出し
    ...
    {
        return  new EngineerPublicBusinessLogic($initdata);
    }
