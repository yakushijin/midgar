...
use BusinessLogic\EngineerBaseEditBusinessLogic;
use Constants\ApiConstants as AC;

final class EngineerBaseEditController extends BaseApiController
{
    //API呼び出し
    ...
    {
        return  new EngineerBaseEditBusinessLogic($initdata);
    }
