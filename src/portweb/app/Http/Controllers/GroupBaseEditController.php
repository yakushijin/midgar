...
use BusinessLogic\GroupBaseEditBusinessLogic;
use Constants\ApiConstants as AC;

final class GroupBaseEditController extends BaseApiController
{
    //API呼び出し
    ...
    {
        return  new GroupBaseEditBusinessLogic($initdata);
    }
