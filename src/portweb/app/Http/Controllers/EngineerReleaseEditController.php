...
use BusinessLogic\EngineerReleaseEditBusinessLogic;
use Constants\ApiConstants as AC;

final class EngineerReleaseEditController extends BaseApiController
{
    //API呼び出し
    ...
    {
        return  new EngineerReleaseEditBusinessLogic($initdata);
    }
