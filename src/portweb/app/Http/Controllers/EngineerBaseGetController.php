...
use BusinessLogic\EngineerBaseGetBusinessLogic;
use Constants\ApiConstants as AC;

final class EngineerBaseGetController extends BaseApiController
{
    //API呼び出し
    ...
    {
        return  new EngineerBaseGetBusinessLogic($initdata);
    }
