...
use BusinessLogic\EngineerSearchBusinessLogic;
use Constants\ApiConstants as AC;

final class EngineerSearchController extends BaseApiController
{
    //API呼び出し
    ...
    {
        return  new EngineerSearchBusinessLogic($initdata);
    }
